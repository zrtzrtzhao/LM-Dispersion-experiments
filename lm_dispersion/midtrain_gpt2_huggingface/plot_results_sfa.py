...
def parse_run_folder_basename(basename):
    ...
    - midtrain_gpt2_other_counter_condensation.py: ..._ccnoise-{neftune_alpha}_fewshot-...,
      ..._ccforget-{K}_fewshot-..., or ..._ccsfa-k{K}-strength{S}_fewshot-...
    """
    ...
    if "_ccsfa-" in basename:
        coeff = basename.split("_ccsfa-")[1].split("_")[0]
        return "ccsfa", coeff, "embedding"
